...
import {Unidade, Departamento} from './unidade.model'
...
export class UnidadeComponent implements OnInit {
  ...
  getOrientacoesConc(){
  	this.unidadeService.orientacoesConcByIdUnidade(this.route.snapshot.params['id'])
  ...
  getProducoesBib(){
    this.unidadeService.producoesBibByIdUnidade(this.route.snapshot.params['id'])
